...
void initSpdLog(std::string uuid, std::string fileName) {
    spdlog::set_async_mode(1024, spdlog::async_overflow_policy::block_retry, nullptr, std::chrono::seconds(30));
    logger = spdlog::rotating_logger_mt(MAIN_LOGGER_NAME, fileName, 1024*1024*1024, 5);
